...
def load_users() -> dict:
    try:
        ...
        # One-time migration from an existing JSON file.
        ...
        log.exception("Failed to load users database; trying JSON backup")
        return _read_json_users(USER_STATE_FILE) or _read_json_users(LEGACY_USER_STATE_FILE)
